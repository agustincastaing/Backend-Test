...
exports.SMTP_PORT = process.env["SMTP_PORT"] ? parseInt(process.env["SMTP_PORT"]) : 587;
...
exports.SHOW_API_DOCS = process.env["SHOW_API_DOCS"] ? process.env["SHOW_API_DOCS"] : false;
exports.INIT_JOBS = process.env["INIT_JOBS"] ? process.env["INIT_JOBS"] : false;
